...
public class MapExample {
    ...
    public static void main(String[] args) {
        ...
        // V put ( K key, V value ) Добавление значения
        // Возвращает старое значение, соответствующее ключу ранее. Если не было ключа - вернет null
        String oldValue = map.put(1, "Hello");
        System.out.println(oldValue);
        map.put(2,"World");
        map.put(3, "Java");

        // вернет null , так как в карте нет такого ключа = нет пары с ключем 4.
        System.out.println("map.put(4, Orange): " + map.put(4, "Python"));
        ...
        // boolean containsValue (Object value) - true, если карта содержит указанное значение ( одно или несколько )
        ...
        System.out.println("map.containsValue(\"Java\"): " + map.containsValue("Java")); // такое значение есть - true
        System.out.println("map.containsValue(\"Orange\"): " + map.containsValue("Orange")); // такого значения нет - false
        System.out.println("map.containsValue(\"NoValue\"): " + map.containsValue("NoValue")); // такое значение есть - false
