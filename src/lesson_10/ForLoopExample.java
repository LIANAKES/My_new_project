...
public class ForLoopExample {
    public static void main(String[] args) {
       ...
       //     System.out.println("Hello World!");
        //Запустиcя бесконечный цикл. Для цикла for ни один из блоков не является обьязательным
...
//  В блоке инициализации  может быть переменная любого типа
      ...
      //  if ( условие ) оператор;
        ...
        // {}- позволяет обьединить в себе несколько команд. От 0 до бесконечности команд
        // for () оператор
        ...
        for (int i =1; i < 7 ; i++){
            ...
            if (i == 3) continue; // continue - прервать текущую итерацию и перейти  к следужщей интеграции цикла
