...
public class MathOperations {
    public static void main(String[] args) {
        ...
        // Alt + Shift + трелки вверх / вниз - перемещать строку по коду
        ...
        // 20 + 7 -> 27 -> result
        result = var1 + var2;
        // Результат вычесления выражения в правой части ( от знака =) присваевается в переменную в левой части
        ...
        */
        ...
        System.out.println("15 / 5: " + 16 / 5); // 3 целых + 1 в остатке
