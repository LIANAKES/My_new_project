...
public class Util {
    ...
    // Метод, возвращающий строковое представыление любого массива
    ...
    // <T extends Number> - тип Т должен либо класом Number либо его наследником
    ...
    // Метод принимает lists.MyArrayList только с элементами типа Number или его наследниками
