...
/*
  Класс Arras предоставляет различные статические методы для работы с массивами.
 */
...
public class ArraysExample {
    public static void main(String[] args) {
        ...
        System.out.println("\n =========== Сравнение массива на равенство ===================\n");
        //           [0, 1, 2, 3]
        int [] test = {0, 1, 2, 3};
        ...
        Кол-во копируемых элментов равно новой длине массива
        Если длина массива больше, чем старого - оставшиеся ячейки заполняются значениями по умолчанию для типа данных массива
         */
        ...
        // Получить новый массив со значениями "старого массива" (копирование обьекта)
        ...
        // Заполнение массива указанным значениям
        int[] arr = new int[5];
        Arrays.fill(arr, 10);
