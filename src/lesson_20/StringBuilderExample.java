...
public class StringBuilderExample {
    public static void main(String[] args) {
        ...
        /*
        StringBuilder - это класс в Java предназначенный для эфективного создания
        ...
        // Метод для добавления в конец строки (приклеить строки) /  аналог конкатенации
      ...
      // Заменить подстроку ( определяется индексами) на указанное значение
        ...
        sb.setLength(3);
        System.out.println("sb.setLenght(3): " + sb);
        ...
        System.out.println("Aбревиатура : " + result );
