...
public class JavaTime {
    ...
    public static void main(String[] args) {
        ...
        // обьект LocalDate неизменяемы. Метод plusDays не изменяет обьект, на котором он вызван
     ...
     //    System.out.println("text: " + text);
      ...
      //      System.out.println(month);
       // }
        ...
        LocalTime parsTime = LocalTime.parse(timeStr);
        ...
        LocalDate localDate = LocalDate.of(2021, Month.AUGUST, 15);
        ...
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MM/yyyy НH:mm:ss ");
        ...
        h - часы в формате от 0 до 12, флаг а для отображения АМ/PM
        m - минута
        s - секунда

        Количество повторений символа определяет формат
        уу - двухзначный год, например 24 для 2024 года
        уууу - 4-значный год
        М - месяц "2" или "12"
        ММ - месяц "02" или "12"
